...
function OnlyNavbar({ className }) {
  ...
  const APP = {
    qR: "https://deo.shopeemobile.com/shopee/shopee-pcmall-live-sg/assets/d91264e165ed6facc6178994d5afae79.png",
    mobile: [
        ...
        <div className={cx("navbar__right")}>
          <ul>
            <Tippy
              ...
              render={(attrs) => (
                <div
                  className={cx("notigication--popper")}
                  tabIndex="-1"
                  {...attrs}
                >
                  <PopperWrapper>
                    {currentUser ? (
                      <div className={cx("popper__notication--inner")}>
                        <p className={cx("title--nocitcation")}>
                      ...
                      <div className={cx("popper__notication--inner")}>
                        ...
                        <div className={cx("btn--outner")}>
                          <Link to={config.register} className={cx("btn")}>
                            Đăng ký
                          </Link>
                          <Link to={config.login} className={cx("btn")}>
                            Đăng nhập
                          </Link>
                        </div>
                      </div>
